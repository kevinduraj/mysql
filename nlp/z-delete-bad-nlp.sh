...
delete_from_tables() {
  ...
  # SQL="DELETE FROM $SOURCE.$TABLE WHERE flesch > 100;"; echo "$SQL"
  # SQL="DELETE FROM $SOURCE.$TABLE WHERE gunning < 5;"; echo "$SQL"
  SQL="DELETE FROM $SOURCE.$TABLE WHERE kincaid > 500;"; echo "$SQL"
